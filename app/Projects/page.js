        ...
        >
          {projects.map((project, index) => (
            <SwiperSlide key={index}>
              <div
                className={`Projects-Container w-full bg-gray-100 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 p-6 flex flex-col justify-between opacity-0 ${
